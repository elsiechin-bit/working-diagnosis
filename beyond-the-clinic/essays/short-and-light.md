...
dek: What parents worry about  -  and what the numbers actually say  -  when a child isn't keeping up on the growth chart.
date: 2026-05-03
layout: topic.njk
specialty: Beyond the Clinic
ctags: [notes, paediatrics, growth]
---

<div class="breadcrumb-trail"><a href="/library/">Library</a> / <a href="/beyond-the-clinic/">Beyond the Clinic</a> / <span class="topic-here">Short and Light</span></div>

{% include "panic-strip.njk" %}
<div class="dont-miss">
<h3>Don't miss</h3>
<ul>
<li>The growth chart is a population distribution, not a diagnostic threshold: 5% of children will always fall below the 5th centile by definition; the clinical question is whether a child is growing at an appropriate velocity for their trajectory.</li>
<li>Constitutional growth delay and familial short stature account for 60-80% of referrals for short stature; calculating mid-parental height and reviewing the growth curve in context resolves most concerns without further investigation.</li>
<li>Growth velocity below 4-4.5 cm per year warrants formal assessment regardless of absolute height centile.</li>
<li>Coeliac disease (NZ prevalence approximately 1 in 100-150) is the most frequently missed cause of faltering growth in primary care; anti-tTG IgA should be in the first-line screen alongside TFTs, FBC, ESR, ferritin, and LFTs.</li>
<li>Growth hormone deficiency affects approximately 1 in 4,000-10,000 children and is characterised by growth velocity below the 25th centile, delayed bone age, and low IGF-1; refer to paediatric endocrinology when suspected.</li>
</ul>
</div>

Every few weeks a parent sits across from me with a folded printout from their child's last school check. The line for height, or weight, or both, sits stubbornly below the others on the growth chart. Sometimes the parent has already googled "growth hormone deficiency" or "coeliac disease." Sometimes they've just been watching their child at birthday parties, noticing that the classmates are taller, heavier, louder somehow.

The worry is real. The underlying cause, in most cases, is not.

Here is how I tend to think through these consultations  -  and what I wish every parent knew before they arrived.

## Most short or light children are simply that: short or light
...
## The causes worth investigating

When the history or growth trajectory raises a flag, the differential is not long, but it matters:
...
**Psychosocial short stature.** Rare, but real. Severe emotional deprivation or chronic stress can suppress growth hormone pulsatility through mechanisms that are not fully understood.<sup>12</sup> The growth pattern often normalises when the child's environment changes.
...
First-line bloods in a child with a clinically uncertain growth trajectory: FBC, ESR, LFTs, renal function, TFTs, anti-tTG IgA with total IgA, ferritin, coeliac serology. This panel will pick up the common organic causes. IGF-1 is a useful screen for GHD but should be interpreted in the context of age and pubertal stage, and in consultation with paediatrics if abnormal.

## What to say to the parent

Parents who are worried about a child's growth are not being anxious without cause  -  the chart is designed to prompt exactly this kind of concern. The most useful thing I can do in these consultations is explain what the chart actually means, walk through the growth trajectory rather than the single measurement, and be honest about what needs investigation and what is likely just the shape of their family tree.

A child who is eating well, growing consistently along any centile, energetic, and developing normally does not need blood tests. They need a parent who feels confident that someone looked, thought it through, and wasn't worried  -  and said so clearly.

That takes about fifteen minutes. It is some of the most useful fifteen minutes in general practice.
