...
- An ARNI (sacubitril/valsartan) or, if not tolerated, an ACE inhibitor or ARB
- A beta-blocker with HF mortality data (bisoprolol, carvedilol, or slow-release metoprolol)
- An MRA (spironolactone, or eplerenone if intolerant)
...
1. **Initiation gap**: Patients leave hospital after an HF admission on one or two pillars rather than four, usually because the team is focused on getting them out alive and stable rather than on full quadruple therapy.
2. **Discharge handover gap**: The cardiology discharge plan often recommends "GP to up-titrate" without specifying which agents to add when, or what the targets are.
3. **Primary care titration gap**: The 15-minute consult is not structurally well-suited to a four-drug titration plan with electrolyte monitoring, blood pressure checks, and symptom review at each step.
4. **MRA underuse specifically**: Spironolactone is consistently the most under-prescribed of the four pillars internationally, partly because of the perceived hyperkalaemia risk (which is real but manageable with monitoring) and partly because adding a fourth drug to an elderly patient on enalapril, bisoprolol, and frusemide feels uncomfortable when each addition individually feels like overshooting.
5. **Frusemide overuse**: Loop diuretics treat congestion but do not modify disease. Patients should generally be on the *lowest dose* of frusemide that controls congestion, not the highest tolerated dose. The four pillars often allow frusemide to be reduced or stopped entirely. The pattern of "increase the frusemide" as a default response to symptoms, without revisiting whether the four pillars are at appropriate doses, is the wrong reflex.
