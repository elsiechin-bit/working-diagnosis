...
summary:
  - "The growth chart is a population distribution, not a diagnostic threshold: 5% of children will always fall below the 5th centile by definition; the clinical question is whether a child is growing at an appropriate velocity for their trajectory."
  - "Constitutional growth delay and familial short stature account for 60-80% of referrals for short stature; calculating mid-parental height and reviewing the growth curve in context resolves most concerns without further investigation."
  - "Growth velocity below 4-4.5 cm per year warrants formal assessment regardless of absolute height centile."
  - "Coeliac disease (NZ prevalence approximately 1 in 100-150) is the most frequently missed cause of faltering growth in primary care; anti-tTG IgA should be in the first-line screen alongside TFTs, FBC, ESR, ferritin, and LFTs."
  - "Growth hormone deficiency affects approximately 1 in 4,000-10,000 children and is characterised by growth velocity below the 25th centile, delayed bone age, and low IGF-1; refer to paediatric endocrinology when suspected."
---
