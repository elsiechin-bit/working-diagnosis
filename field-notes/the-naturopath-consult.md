...
date: 2026-04-22
summary:
  - "Naturopathy is unregulated in New Zealand: anyone may legally practise and use the title, making the qualification behind a 'naturopath' label highly variable; this shapes how to receive their recommendations."
  - "Naturopathic testing commonly ordered in NZ (IgG food panels, hair mineral analysis, saliva hormone tests, stool microbiome maps) is largely not validated for clinical decision-making and should not prompt referral or treatment changes based on results alone."
  - "A three-bucket framework helps: things with reasonable evidence for specific indications (some probiotics, omega-3, vitamin D for deficiency, folate); things lacking evidence but unlikely to harm; and things with evidence of harm or clinically dangerous interactions."
  - "The most important safety check is identifying supplements with clinically significant interactions: St John's Wort (CYP3A4), garlic/fish oil (antiplatelet), kava (hepatotoxicity), licorice root (hypertension and hypokalaemia)."
  - "How the consultation is handled shapes whether the patient keeps coming back; acknowledging what the naturopath got right, engaging with the patient's concerns, and focusing on safety rather than ideology is more effective than a dismissive response."
---
