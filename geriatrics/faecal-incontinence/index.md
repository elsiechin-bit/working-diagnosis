...
<p>
    ...
    <p>
      Assessment should include: medication review, rectal examination (check for faecal loading, sphincter tone, and anal sensation), and assessment of cognitive and functional status (the ability to recognise urgency and reach a toilet in time is often the limiting factor in cognitive impairment or mobility limitation). Endoscopy, anorectal manometry, and pelvic floor imaging are investigations for secondary care when the cause is unclear or conservative management has failed.
    </p>

    <p>
      Management in primary care centres on: treating the underlying cause (constipation, diarrhoea, medication), dietary review (adequate fibre and fluid intake; avoid caffeine and alcohol as they increase bowel urgency), a timed voiding programme (scheduled toileting after meals exploits the gastrocolic reflex), and pelvic floor physiotherapy referral. Pelvic floor exercises and biofeedback have reasonable evidence for improving sphincter function even in older adults.<sup>2</sup> Loperamide is appropriate for diarrhoea-predominant faecal incontinence and can be used regularly, not just acutely.
    </p>
