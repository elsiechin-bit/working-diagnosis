...
<div class="topic">
  ...
  <div class="topic-body">
    ...
    <p>
      When a patient is unwilling to stop driving despite advice, the GP's options are: to seek support from family (with the patient's consent where possible), to request a formal on-road assessment (which can be framed as an objective test rather than a clinical opinion), and ultimately to notify the NZTA directly if the safety risk is serious and the patient refuses to comply. This notification is a professional obligation under the Land Transport Act 1998 and overrides the usual duty of confidentiality. Inform the patient of your intention to notify, and document the notification in the clinical record.
    </p>
